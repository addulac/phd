...
* Generate the class membership distributions $\mat{\Theta}_{N \times \infty}$:
   \begin{align}
    ...
    \mat{\theta}_i &\sim \DP(\alpha_0, \beta) \quad\text{ for } i \in \{1, .., N\} \nonumber
   \end{align}
...
\end{equation}
and usually makes use of standard Gibbs sampling and Metropolis-Hastings algorithms^[We do not detail the inference of $\mat{\hat{\Theta}}$ and $\mat{\hat{\Phi}}$ here and refer the interested reader to [@ILFRM][@IBP][@HDP][@fan2015dynamic].].
