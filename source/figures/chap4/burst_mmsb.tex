...
\begin{subfigure}
     \centering
         \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/3_prop2_process_local_me__85}
\end{subfigure}
\begin{subfigure}
         \centering
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/3_prop2_process_local_me__95} 
\end{subfigure}                                                                          
\begin{subfigure}                                                                        
         \centering                                                                      
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/5_prop2_process_local_me__85}
\end{subfigure}                                                                          
\begin{subfigure}                                                                        
         \centering                                                                      
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/5_prop2_process_local_me__95}
\end{subfigure}                                                                          
