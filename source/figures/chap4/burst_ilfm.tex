...
\begin{subfigure}
     \centering
         \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/2_prop2_process_local_me__85}
\end{subfigure}
\begin{subfigure}
         \centering
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/2_prop2_process_local_me__95} 
\end{subfigure}                                                                          
\begin{subfigure}                                                                        
         \centering                                                                      
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/4_prop2_process_local_me__85}
\end{subfigure}                                                                          
\begin{subfigure}                                                                        
         \centering                                                                      
      \includegraphics[width=0.45\textwidth]{source/figures/chap4/burst/4_prop2_process_local_me__95}
\end{subfigure}                                                                          
